# tilezz simple matchstick polygons on Z[zeta_8], perimeter <= 20, free

Simple matchstick polygons -- closed self-avoiding polygonal walks with unit-length edges and turn angles in integer multiples of `2*pi/8` -- on the cyclotomic ring `Z[zeta_8]`, with perimeter up to 20, canonicalised under free (full dihedral symmetry reduction) symmetry. 2940554725 sequences.

Upstream cross-reference: this dataset realises OEIS sequence [`A316198`](https://oeis.org/A316198).
