# tilezz simple matchstick polygons on Z[zeta_6], perimeter <= 24, free

Simple matchstick polygons -- closed self-avoiding polygonal walks with unit-length edges and turn angles in integer multiples of `2*pi/6` -- on the cyclotomic ring `Z[zeta_6]`, with perimeter up to 24, canonicalised under free (full dihedral symmetry reduction) symmetry. 7099803810 sequences.

Upstream cross-reference: this dataset realises OEIS sequence [`A284869`](https://oeis.org/A284869).
