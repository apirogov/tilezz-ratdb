#!/bin/sh
#
# Rebuild this dataset (tilezz-rat-zz3-n39-free) from source.
...
./target/release/rat_enum --ring 6 -n 39 --free --step 2 --mode stream --threads 16 -o tilezz-rat-zz3-n39-free-pipeline
./target/release/rat_enum --ring 6 -n 39 --free --step 2 --mode merge -o tilezz-rat-zz3-n39-free-pipeline
./target/release/rat_enum --ring 6 -n 39 --free --step 2 --mode build --target-block-bytes 4194304 -o tilezz-rat-zz3-n39-free-pipeline
mv tilezz-rat-zz3-n39-free-pipeline/dafsa tilezz-rat-zz3-n39-free
echo
echo "Reproduced asset: $(pwd)/tilezz-rat-zz3-n39-free"
