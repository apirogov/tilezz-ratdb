#!/bin/sh
#
# Rebuild this dataset (tilezz-rat-zz9-n18-free) from source.
...
COMMIT="${COMMIT:-3cdd7eca1425f25769042ed0eb2274f97db6de40}"
SRC_DIR="${SRC_DIR:-tilezz-3cdd7eca1425f25769042ed0eb2274f97db6de40}"
...
./target/release/rat_enum --ring 18 -n 18 --free --step 2 --mode stream --threads 16 -o tilezz-rat-zz9-n18-free-pipeline
./target/release/rat_enum --ring 18 -n 18 --free --step 2 --mode merge -o tilezz-rat-zz9-n18-free-pipeline
./target/release/rat_enum --ring 18 -n 18 --free --step 2 --mode build --target-block-bytes 4194304 -o tilezz-rat-zz9-n18-free-pipeline
mv tilezz-rat-zz9-n18-free-pipeline/dafsa tilezz-rat-zz9-n18-free
echo
echo "Reproduced asset: $(pwd)/tilezz-rat-zz9-n18-free"
