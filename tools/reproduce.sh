#!/bin/sh
#
# Rebuild this dataset (tilezz-rat-zz5-n25-free) from source.
...
COMMIT="${COMMIT:-7b63a8895289033f229fb1e05815d1948f23983e}"
SRC_DIR="${SRC_DIR:-tilezz-7b63a8895289033f229fb1e05815d1948f23983e}"
...
./target/release/rat_enum --ring 10 -n 25 --free --step 2 --mode stream --threads 16 -o tilezz-rat-zz5-n25-free-pipeline
./target/release/rat_enum --ring 10 -n 25 --free --step 2 --mode merge -o tilezz-rat-zz5-n25-free-pipeline
./target/release/rat_enum --ring 10 -n 25 --free --step 2 --mode build --target-block-bytes 4194304 -o tilezz-rat-zz5-n25-free-pipeline
mv tilezz-rat-zz5-n25-free-pipeline/dafsa tilezz-rat-zz5-n25-free
echo
echo "Reproduced asset: $(pwd)/tilezz-rat-zz5-n25-free"
