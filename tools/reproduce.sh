#!/bin/sh
#
# Rebuild this dataset (tilezz-rat-zz6-n24-free) from source.
...
./target/release/rat_enum --ring 6 -n 24 --free --oeis-a-number A284869 --mode stream --threads 16 -o tilezz-rat-zz6-n24-free-pipeline
./target/release/rat_enum --ring 6 -n 24 --free --oeis-a-number A284869 --mode merge -o tilezz-rat-zz6-n24-free-pipeline
./target/release/rat_enum --ring 6 -n 24 --free --oeis-a-number A284869 --mode build --target-block-bytes 4194304 -o tilezz-rat-zz6-n24-free-pipeline
mv tilezz-rat-zz6-n24-free-pipeline/dafsa tilezz-rat-zz6-n24-free
echo
echo "Reproduced asset: $(pwd)/tilezz-rat-zz6-n24-free"
