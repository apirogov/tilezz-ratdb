#!/bin/sh
#
# Rebuild this dataset (tilezz-rat-zz7-n21-free) from source.
...
./target/release/rat_enum --ring 14 -n 21 --free --step 2 --mode stream --threads 16 -o tilezz-rat-zz7-n21-free-pipeline
./target/release/rat_enum --ring 14 -n 21 --free --step 2 --mode merge -o tilezz-rat-zz7-n21-free-pipeline
./target/release/rat_enum --ring 14 -n 21 --free --step 2 --mode build --target-block-bytes 4194304 -o tilezz-rat-zz7-n21-free-pipeline
mv tilezz-rat-zz7-n21-free-pipeline/dafsa tilezz-rat-zz7-n21-free
echo
echo "Reproduced asset: $(pwd)/tilezz-rat-zz7-n21-free"
