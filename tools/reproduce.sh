#!/bin/sh
#
# Rebuild this dataset (tilezz-rat-zz12-n16-free) from source.
...
./target/release/rat_enum --ring 12 -n 16 --free --oeis-a-number A316192 --mode stream --threads 16 -o tilezz-rat-zz12-n16-free-pipeline
./target/release/rat_enum --ring 12 -n 16 --free --oeis-a-number A316192 --mode merge -o tilezz-rat-zz12-n16-free-pipeline
./target/release/rat_enum --ring 12 -n 16 --free --oeis-a-number A316192 --mode build --target-block-bytes 4194304 -o tilezz-rat-zz12-n16-free-pipeline
mv tilezz-rat-zz12-n16-free-pipeline/dafsa tilezz-rat-zz12-n16-free
echo
echo "Reproduced asset: $(pwd)/tilezz-rat-zz12-n16-free"
