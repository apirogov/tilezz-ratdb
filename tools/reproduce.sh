#!/bin/sh
#
# Rebuild this dataset (tilezz-rat-zz10-n18-free) from source.
...
./target/release/rat_enum --ring 10 -n 18 --free --oeis-a-number A316200 --mode stream --threads 16 -o tilezz-rat-zz10-n18-free-pipeline
./target/release/rat_enum --ring 10 -n 18 --free --oeis-a-number A316200 --mode merge -o tilezz-rat-zz10-n18-free-pipeline
./target/release/rat_enum --ring 10 -n 18 --free --oeis-a-number A316200 --mode build --target-block-bytes 4194304 -o tilezz-rat-zz10-n18-free-pipeline
mv tilezz-rat-zz10-n18-free-pipeline/dafsa tilezz-rat-zz10-n18-free
echo
echo "Reproduced asset: $(pwd)/tilezz-rat-zz10-n18-free"
